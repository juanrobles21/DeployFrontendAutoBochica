...
export const CertificatePerson = () => {
  // ************************************************************************
  ...
  const getPersons = async () => {
    const result = await ServicePrivate.requestGET(
      ApiBack.FILTER_CERTIFICATE_PERSON
    );
    console.log(result);
  ...
  const fileName = "CERTIFICADOS" + "//" + Date(); // here enter filename for your excel file
  const fetchData = () => {
    axios
      .get("https://autobochicabackend.onrender.com/api/private/person/detailscertificateexcel")
      ...
      <div className="pagetitle">
        ...
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Usuarios Certificados</li>
          </ol>
        </nav>
      </div>
