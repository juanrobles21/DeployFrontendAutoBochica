...
export const AdminNoCertificatePerson = () => {
  // ************************************************************************
  ...
  const borrarPerfil = async (idPerson: string) => {
    ...
    if (typeof resultado.ok === "undefined") {
      ...
      MessageToastify(
        "success",
        "Perfil eliminado con exito de la base de datos",
        7000
      );
    }
    getPersons();
        ...
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">
              Administración Usuarios No Certificados
            </li>
          </ol>
        </nav>
      </div>
          ...
          <div className="card-body">
                ...
                <tbody>
                  {arrayPerson.map((myPerson, index) => (
                    <tr key={index}>
                      ...
                      <td className="text-center align-middle">
                        <Link to={"/home/person/details/" + myPerson.idPerson}>
                        ...
                        <Link to={"/home/person/update/" + myPerson.idPerson}>
                          <i
            ...
            >
              ...
              <Modal.Body>
                ...
                <br />
                <strong>
                  {objPer.firstName}-{objPer.firstLastName}
                </strong>
              </Modal.Body>
              <Modal.Footer>
                <Button
